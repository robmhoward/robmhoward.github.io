...
(function (Word) {
    var Body = (function (_super) {
        ...
        Object.defineProperty(Body.prototype, "html", {
            get: function () {
                OfficeExtension.Utility.throwIfNotLoaded("html", this.m_html);
                return this.m_html;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Body.prototype, "ooxml", {
            get: function () {
                OfficeExtension.Utility.throwIfNotLoaded("ooxml", this.m_ooxml);
                return this.m_ooxml;
            },
            enumerable: true,
            configurable: true
    ...
    var ContentControl = (function (_super) {
        ...
        ContentControl.prototype.insertParagraph = function (paragraphText, loc) {
            return new Word.Paragraph(this.context, OfficeExtension.ObjectPathFactory.createMethodObjectPath(this.context, this, "InsertParagraph", 0 /* Default */, [paragraphText, loc], false, true));
        };
    ...
    var Paragraph = (function (_super) {
        ...
        Object.defineProperty(Paragraph.prototype, "ooxml", {
            get: function () {
                OfficeExtension.Utility.throwIfNotLoaded("ooxml", this.m_ooxml);
                return this.m_ooxml;
            },
    ...
    var Range = (function (_super) {
        ...
        Object.defineProperty(Range.prototype, "html", {
            get: function () {
                OfficeExtension.Utility.throwIfNotLoaded("html", this.m_html);
                return this.m_html;
            },
        ...
        Object.defineProperty(Range.prototype, "ooxml", {
            get: function () {
                OfficeExtension.Utility.throwIfNotLoaded("ooxml", this.m_ooxml);
                return this.m_ooxml;
            },
        ...
        Range.prototype.insertBreak = function (bt, loc) {
            OfficeExtension.ActionFactory.createMethodAction(this.context, this, "InsertBreak", 1 /* Read */, [bt, loc]);
        };
        ...
        Range.prototype.insertParagraph = function (paragraphText, loc) {
            return new Word.Paragraph(this.context, OfficeExtension.ObjectPathFactory.createMethodObjectPath(this.context, this, "InsertParagraph", 1 /* Read */, [paragraphText, loc], false, true));
        };
