declare module Word {
    class Body extends OfficeExtension.ClientObject {
        ...
        _ReferenceId: string;
        clear(): void;
        insertBreak(bt: string, loc: string): void;
        insertContentControl(): Word.ContentControl;
        insertFileFromBase64(base64File: string, loc: string): Word.Range;
        insertHtml(html: string, loc: string): Word.Range;
        insertOoxml(ooxml: string, loc: string): Word.Range;
        insertParagraph(paragraphText: string, loc: string): Word.Paragraph;
        insertText(txt: string, loc: string): Word.Range;
    ...
    class Paragraph extends OfficeExtension.ClientObject {
        ...
        insertFileFromBase64(base64File: string, loc: string): Word.Range;
        insertHtml(html: string, loc: string): Word.Range;
        insertInlinePictureFromBase64(base64EncodedImage: string, loc: string): Word.InlinePicture;
        insertOoxml(ooxml: string, loc: string): Word.Range;
        insertParagraph(paragraphText: string, loc: string): Word.Paragraph;
        insertText(txt: string, loc: string): Word.Range;
        select(): void;
