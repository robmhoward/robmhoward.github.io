...
declare module OfficeExtension {
    ...
    class ClientRequestContext {
        ...
        customData: string;
        m_requestExecutor: IRequestExecutor;
        constructor(url?: string);
        _pendingRequest: ClientRequest;
        pendingRequest: ClientRequest;
        references: References;
        load(clientObj: ClientObject, option?: any): void;
...
declare module OfficeExtension {
    class Utility {
        ...
        static getResourceString(resourceId: string, arg?: string): string;
        static log(message: string): void;
        static load(clientObj: ClientObject, option?: any): void;
